    ...
    Process {
        ...
        Foreach ($FileItem in $FileItems) {
            ...
            Try {
                ...
                $ContainsDateTaken = $true
                $Img = [System.Drawing.Imaging.Metafile]::FromStream($FileStream)
                if ($Img.PropertyIdList.Contains(36867) -eq $false) {
                    $ContainsDateTaken = $false
                }
                $ExifDT = $Img.GetPropertyItem('36867')
            }
            Catch {
                if ($ContainsDateTaken) {
            ...
            Try {
                ...
                if ($ExifDtString.Contains("0000:00:00 00:00:00")) {
                    return $null
                }
            ...
            Catch {
                Write-Warning -Message "Problem reading Exif DateTaken string - '$ExifDtString' in $ImageFile ($_)"
                Break
            }
            Finally {
                If ($Img) {$Img.Dispose()}
